...
void DCLL :: insert_first(int data)
{
    PNODE newn = new NODE;
...
void DCLL :: insert_last(int data)
{
    PNODE newn = new NODE;
...
void DCLL :: insert_position(int position, int data)
{
    int nodeCnt = count();
    int iCnt = 0;
    PNODE newn = new NODE;
...
void DCLL :: delete_position(int position)
{
    int nodeCnt = count();
    int iCnt = 0;
    PNODE temp = NULL;
